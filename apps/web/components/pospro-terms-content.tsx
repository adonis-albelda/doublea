// Full text supplied by the user, verbatim, except two bracketed
// placeholders from the template ([SUPPORT EMAIL], [BUSINESS ADDRESS]) —
// filled with the business's real, already-public contact email and
// Calbayog City address used elsewhere on this site.
export function PosProTermsContent() {
  return (
    <div className="prose-legal flex flex-col gap-6 text-body text-muted-foreground [&_h2]:mt-4 [&_h2]:font-display [&_h2]:text-h3 [&_h2]:text-foreground [&_strong]:text-foreground [&_ul]:flex [&_ul]:list-disc [&_ul]:flex-col [&_ul]:gap-2 [&_ul]:pl-5">
      <p>
      ...
      <ul>
        ...
        <li>Terminal and cashier management</li>
      ...
      <ul>
        ...
        <li>Reviewing user access</li>
        <li>Immediately notifying us of unauthorized access</li>
      </ul>
      <p>
        You are responsible for activities performed through your account unless caused by our failure to provide
        reasonable security measures.
      </p>
      <p>Do not share your personal administrator credentials with other users.</p>
      <p>Where possible, create separate accounts for employees and assign only the permissions they need.</p>
      ...
      <p>We do not claim ownership of your business records.</p>
      ...
      <p>You should:</p>
      <ul>
        <li>Collect only information necessary for your business purposes</li>
        <li>Provide appropriate privacy notices</li>
        <li>Obtain consent where required</li>
        <li>Configure appropriate user permissions</li>
      ...
      <ul>
        ...
        <li>Commit fraud</li>
        <li>Process unauthorized transactions</li>
      ...
      <p>
        We may suspend or restrict accounts involved in serious violations of these Terms or activities that
        create a significant security or legal risk.
      </p>
      ...
      <ul>
        ...
        <li>Taxes are configured correctly where applicable</li>
        <li>Discounts are correctly configured</li>
        <li>Products and inventory information is accurate</li>
        <li>Refunds are authorized</li>
        <li>Voids are authorized</li>
        <li>Employees have appropriate permissions</li>
      ...
      <p>You are responsible for:</p>
      <ul>
        <li>Performing physical inventory counts where appropriate</li>
        <li>Ensuring product information is accurate</li>
        <li>Recording legitimate stock movements</li>
      ...
      <h2>14. Internet and Device Requirements</h2>
      <p>You are responsible for providing:</p>
      <ul>
        <li>Compatible devices</li>
        <li>Internet connectivity where required</li>
        <li>Electricity and appropriate hardware</li>
      ...
      <ul>
        <li>Fees may be recurring</li>
        <li>Taxes may apply</li>
        <li>Payment methods may vary</li>
        <li>Plans may have usage limits</li>
        <li>Features may vary by plan</li>
      </ul>
      ...
      <p>We may suspend or terminate an account when:</p>
      <ul>
      ...
      <h2>20. Data After Account Termination</h2>
      <p>After account termination, we may retain certain information for:</p>
      <ul>
        <li>Legal compliance</li>
        <li>Tax or financial requirements</li>
      ...
      <p>Subject to applicable laws and our retention policies, data may eventually be deleted or anonymized.</p>
      <p>
        If you need a copy of your business information before terminating your account, you should export or
        request the applicable data while your account remains active.
      </p>
      ...
      <p>This may include losses arising from:</p>
      <ul>
        <li>Lost profits</li>
        ...
        <li>Loss of data</li>
        <li>Third-party service failures</li>
        <li>Internet or connectivity failures</li>
      </ul>
      ...
      <ul>
        ...
        <li>Unauthorized transactions or business activities conducted through your account</li>
      </ul>
      ...
      <p>
        These Terms shall be governed by the laws of the Republic of the Philippines, unless otherwise required by
        applicable law or agreed in writing.
      </p>
      <p>Any dispute shall be handled through the appropriate legal process and jurisdiction applicable under Philippine law.</p>
